...
public class SimpleTaggerTest {
    ...
    public void testTagger() throws IOException {
        assertSents(Lists.newArrayList("(TOP (ADJF,accs,inan,plur женские) (NOUN,inan,masc,nomn,plur сапоги))",
        ...
        assertSents(Lists.newArrayList("(TOP (ADJF,accs,inan,plur женские) (NOUN,inan,masc,nomn,plur сапоги) (PREP на) (NOUN,accs,femn,inan,sing зиму))",
